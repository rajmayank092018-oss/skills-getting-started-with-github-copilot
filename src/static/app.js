document.addEventListener("DOMContentLoaded", () => {
          ...
          participantsHTML = `
            ...
            <ul class="participants-list">
              ${details.participants
                .map(
                  (p) =>
                    `<li class="participant-item" data-email="${p}" data-activity="${name}"><span class="participant-email">${p}</span><button class="delete-participant" title="Unregister">✖</button></li>`
                )
                .join("")}
            </ul>
          `;
  ...
  // Delegate click events for delete/unregister buttons
